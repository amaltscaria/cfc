...
const EmissionsCard = () => {
  ...
  if (offs > 9999999) {
    val = (offs / 10000000).toFixed(1) + "Cr";
  } else if (offs > 99999) {
    val = (offs / 100000).toFixed(1) + "L";
  }
  let yes = false;
  if (val !== offs) {
    yes = true;
  ...
  function formatNumber(number) {
    ...
    if (number >= threshold || number <= -threshold) {
      return number.toExponential(1); // Show in scientific notation with 2 decimal places
    } else {
                  ...
                  <div className="bg-white outfit-medium rounded-lg ">
                    <div>
                      <a
                        ...
                        rel="noopener noreferrer"
                      >
                        <div className="relative w-[155px] h-[70px] lg:w-[205px] lg:h-[110px] rounded-md mx-auto mb-[8px]">
                          <img
                            src={img2}
                            alt=""
